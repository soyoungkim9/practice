...
import bitcamp.java106.pms6.dao.BoardDao;
import bitcamp.java106.pms6.domain.Board;
...
public class BoardController3 {
    ...
    void onBoardAdd() {
        ...
        System.out.print("제목? ");
        board.setSubject(this.keyScan.nextLine());
        System.out.print("내용? ");
        board.setContent(this.keyScan.nextLine());
        System.out.print("등록일? ");
        board.setDate(Date.valueOf(this.keyScan.nextLine()));
    ...
    void onBoardList() {
        ...
        for(int i = 0; i < board.length; i++) {
            ...
            System.out.printf("%d, %s, %s\n",
                i, board[i].getSubject(), board[i].getDate());
        }
